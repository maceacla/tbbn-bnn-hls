...
void r_64_16(ap_int<2>data0[64], ap_int<2>data1[16]){
	...
	for (int lidx0=0; lidx0<64; lidx0++){
	   ...
	   ap_int<16>val32=data4[lidx0];
	   float val33=data3[lidx0];
	   data0[lidx0]=((((((((((((((((((((((val0*val31)+(val1*val16))+(val2*val17))+(val3*val18))+(val4*val19))+(val5*val20))+(val6*val21))+(val7*val22))+(val8*val23))+(val9*val24))+(val10*val25))+(val11*val26))+(val12*val27))+(val13*val28))+(val14*val29))+(val15*val30))+(val33*-1.0)))<(0.0))) ? -1.0 : 1.0)*val32);
	}
}